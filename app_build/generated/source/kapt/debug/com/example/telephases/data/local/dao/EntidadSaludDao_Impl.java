...
public final class EntidadSaludDao_Impl implements EntidadSaludDao {
  ...
  @Override
  public Object insert(final EntidadSaludEntity entidad,
  ...
  @Override
  public Object delete(final EntidadSaludEntity entidad,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
  ...
  @Override
  public Object update(final EntidadSaludEntity entidad,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
  ...
  @Override
  public Object getById(final int id, final Continuation<? super EntidadSaludEntity> $completion) {
  ...
  public Object getByServerId(final int serverId,
      final Continuation<? super EntidadSaludEntity> $completion) {
  ...
  @Override
  public Object getByNit(final String nit,
      final Continuation<? super EntidadSaludEntity> $completion) {
  ...
  @Override
  public Object getUnsynced(final Continuation<? super List<EntidadSaludEntity>> $completion) {
  ...
  @Override
  public Object getAllActiveSync(final Continuation<? super List<EntidadSaludEntity>> $completion) {
