...
import com.example.telephases.workers.NetworkMonitorWorker;
import com.example.telephases.workers.NetworkMonitorWorker_AssistedFactory;
...
public final class DaggerTelephaseApplication_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends TelephaseApplication_HiltComponents.SingletonC {
    ...
    private Map<String, Provider<WorkerAssistedFactory<? extends ListenableWorker>>> mapOfStringAndProviderOfWorkerAssistedFactoryOf(
      ...
      return MapBuilder.<String, Provider<WorkerAssistedFactory<? extends ListenableWorker>>>newMapBuilder(3).put("com.example.telephases.workers.MaintenanceWorker", ((Provider) maintenanceWorker_AssistedFactoryProvider)).put("com.example.telephases.workers.NetworkMonitorWorker", ((Provider) networkMonitorWorker_AssistedFactoryProvider)).put("com.example.telephases.workers.SyncWorker", ((Provider) syncWorker_AssistedFactoryProvider)).build();
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.networkMonitorWorker_AssistedFactoryProvider = SingleCheck.provider(new SwitchingProvider<NetworkMonitorWorker_AssistedFactory>(singletonCImpl, 9));
      ...
      this.databaseInitializerProvider = DoubleCheck.provider(new SwitchingProvider<DatabaseInitializer>(singletonCImpl, 11));
      this.provideWorkSchedulerProvider = DoubleCheck.provider(new SwitchingProvider<WorkScheduler>(singletonCImpl, 13));
      this.provideNetworkConnectivityManagerProvider = DoubleCheck.provider(new SwitchingProvider<NetworkConnectivityManager>(singletonCImpl, 12));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 9: // com.example.telephases.workers.NetworkMonitorWorker_AssistedFactory 
          return (T) new NetworkMonitorWorker_AssistedFactory() {
            @Override
            public NetworkMonitorWorker create(Context context2, WorkerParameters workerParams2) {
              return new NetworkMonitorWorker(context2, workerParams2, singletonCImpl.provideSyncManagerProvider.get());
            }
          };

          case 10: // com.example.telephases.workers.SyncWorker_AssistedFactory 
          return (T) new SyncWorker_AssistedFactory() {
            @Override
            public SyncWorker create(Context context3, WorkerParameters workerParams3) {
              return new SyncWorker(context3, workerParams3, singletonCImpl.provideSyncManagerProvider.get(), singletonCImpl.provideAuthRepositoryProvider.get());
            }
          };

          case 11: // com.example.telephases.data.local.database.DatabaseInitializer 
          return (T) new DatabaseInitializer(singletonCImpl.provideAppDatabaseProvider.get());

          case 12: // com.example.telephases.utils.NetworkConnectivityManager 
          ...
          case 13: // com.example.telephases.workers.WorkScheduler 
