...
public final class UsuarioSedeDao_Impl implements UsuarioSedeDao {
  ...
  @Override
  public Object insert(final UsuarioSedeEntity usuarioSede, final Continuation<? super Unit> arg1) {
  ...
  @Override
  public Object delete(final UsuarioSedeEntity usuarioSede, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object update(final UsuarioSedeEntity usuarioSede, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object softDeleteByUsuario(final String usuarioId, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object softDeleteBySede(final int sedeId, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  public Object getByUsuarioAndSede(final String usuarioId, final int sedeId,
      final Continuation<? super UsuarioSedeEntity> arg2) {
  ...
  @Override
  public Object getCountBySede(final int sedeId, final Continuation<? super Integer> arg1) {
