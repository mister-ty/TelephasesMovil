...
public final class SedeDao_Impl implements SedeDao {
  ...
  @Override
  public Object insert(final SedeEntity sede, final Continuation<? super Long> arg1) {
  ...
  @Override
  public Object insertAll(final List<SedeEntity> sedes, final Continuation<? super Unit> arg1) {
  ...
  @Override
  public Object delete(final SedeEntity sede, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object update(final SedeEntity sede, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Object getById(final int id, final Continuation<? super SedeEntity> arg1) {
  ...
  @Override
  public Object getByServerId(final int serverId, final Continuation<? super SedeEntity> arg1) {
  ...
  @Override
  public Object getUnsynced(final Continuation<? super List<SedeEntity>> arg0) {
  ...
  @Override
  public Object getAllActiveSync(final Continuation<? super List<SedeEntity>> arg0) {
