  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(10) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `maletas` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `maletaUid` TEXT, `identificadorInvima` TEXT NOT NULL, `nombreMaleta` TEXT, `descripcion` TEXT, `asignadaAUsuarioId` TEXT, `entidadSaludId` INTEGER, `ultimaRevision` TEXT, `activa` INTEGER NOT NULL, `serverId` INTEGER, FOREIGN KEY(`asignadaAUsuarioId`) REFERENCES `users`(`id`) ON UPDATE NO ACTION ON DELETE SET NULL , FOREIGN KEY(`entidadSaludId`) REFERENCES `entidades_salud`(`id`) ON UPDATE NO ACTION ON DELETE SET NULL )");
        db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS `index_maletas_maletaUid` ON `maletas` (`maletaUid`)");
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_maletas_asignadaAUsuarioId` ON `maletas` (`asignadaAUsuarioId`)");
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_maletas_entidadSaludId` ON `maletas` (`entidadSaludId`)");
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_maletas_activa` ON `maletas` (`activa`)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'ef0617c28742d98c1a638bdb55e0c471')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsMaletas = new HashMap<String, TableInfo.Column>(10);
        _columnsMaletas.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMaletas.put("maletaUid", new TableInfo.Column("maletaUid", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashSet<TableInfo.Index> _indicesMaletas = new HashSet<TableInfo.Index>(4);
        _indicesMaletas.add(new TableInfo.Index("index_maletas_maletaUid", true, Arrays.asList("maletaUid"), Arrays.asList("ASC")));
        _indicesMaletas.add(new TableInfo.Index("index_maletas_asignadaAUsuarioId", false, Arrays.asList("asignadaAUsuarioId"), Arrays.asList("ASC")));
        _indicesMaletas.add(new TableInfo.Index("index_maletas_entidadSaludId", false, Arrays.asList("entidadSaludId"), Arrays.asList("ASC")));
        _indicesMaletas.add(new TableInfo.Index("index_maletas_activa", false, Arrays.asList("activa"), Arrays.asList("ASC")));
    ...
    }, "ef0617c28742d98c1a638bdb55e0c471", "08cf254a8339e65a6f4a6b36cdf6f912");
