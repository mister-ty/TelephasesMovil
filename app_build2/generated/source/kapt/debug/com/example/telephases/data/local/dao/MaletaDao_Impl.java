  ...
  public MaletaDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMaletaEntity = new EntityInsertionAdapter<MaletaEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `maletas` (`id`,`maletaUid`,`identificadorInvima`,`nombreMaleta`,`descripcion`,`asignadaAUsuarioId`,`entidadSaludId`,`ultimaRevision`,`activa`,`serverId`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getMaletaUid() == null) {
          statement.bindNull(2);
        } else {
          statement.bindString(2, entity.getMaletaUid());
        }
        if (entity.getIdentificadorInvima() == null) {
          statement.bindNull(3);
        } else {
          statement.bindString(3, entity.getIdentificadorInvima());
        }
        if (entity.getNombreMaleta() == null) {
          statement.bindNull(4);
        } else {
          statement.bindString(4, entity.getNombreMaleta());
        }
        ...
        if (entity.getAsignadaAUsuarioId() == null) {
          ...
          statement.bindString(6, entity.getAsignadaAUsuarioId());
        }
        if (entity.getEntidadSaludId() == null) {
          statement.bindNull(7);
        } else {
          statement.bindLong(7, entity.getEntidadSaludId());
        }
        if (entity.getUltimaRevision() == null) {
          statement.bindNull(8);
        } else {
          statement.bindString(8, entity.getUltimaRevision());
        }
    ...
    this.__updateAdapterOfMaletaEntity = new EntityDeletionOrUpdateAdapter<MaletaEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `maletas` SET `id` = ?,`maletaUid` = ?,`identificadorInvima` = ?,`nombreMaleta` = ?,`descripcion` = ?,`asignadaAUsuarioId` = ?,`entidadSaludId` = ?,`ultimaRevision` = ?,`activa` = ?,`serverId` = ? WHERE `id` = ?";
      }
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"maletas"}, new Callable<List<MaletaEntity>>() {
      ...
      public List<MaletaEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfMaletaUid = CursorUtil.getColumnIndexOrThrow(_cursor, "maletaUid");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpMaletaUid;
            if (_cursor.isNull(_cursorIndexOfMaletaUid)) {
              _tmpMaletaUid = null;
            } else {
              _tmpMaletaUid = _cursor.getString(_cursorIndexOfMaletaUid);
            }
            ...
            _item = new MaletaEntity(_tmpId,_tmpMaletaUid,_tmpIdentificadorInvima,_tmpNombreMaleta,_tmpDescripcion,_tmpAsignadaAUsuarioId,_tmpEntidadSaludId,_tmpUltimaRevision,_tmpActiva,_tmpServerId);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public MaletaEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new MaletaEntity(_tmpId,_tmpMaletaUid,_tmpIdentificadorInvima,_tmpNombreMaleta,_tmpDescripcion,_tmpAsignadaAUsuarioId,_tmpEntidadSaludId,_tmpUltimaRevision,_tmpActiva,_tmpServerId);
          } else {
            _result = null;
          }
          return _result;
